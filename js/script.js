...
// do
// cum
document.getElementById('host-name').innerHTML = 'Molly';
document.getElementById('collaborator-name').innerHTML = 'Meghan';
document.getElementById('collaborator-2-name').innerHTML = 'Rosalie!!';
...
// document.querySelector("question").addEventListener("click", toggle(){
// console.log("testerr");
// })
